...
function Dashboard({ employees }: DashboardProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1450px]">
      <h1
        className="
          relative mb-8 text-[31px] font-extrabold tracking-[-1.1px] text-[#111827]
          after:mt-[10px] after:block after:h-1 after:w-12 after:rounded-[20px]
      ...
      <div
        className="
          ...
          max-[650px]:grid-cols-1 max-[650px]:gap-[13px]
        "
      >
        {stats.map(([title, value]) => (
          <div
            key={title}
            className="
              relative flex min-h-[155px] flex-col justify-between
              ...
              after:absolute after:-bottom-[45px] after:-right-[35px] after:h-[125px] after:w-[125px]
              after:rounded-full
              after:bg-[radial-gradient(circle,rgba(99,102,241,0.12),transparent_70%)]
              max-[650px]:min-h-[135px] max-[650px]:p-5
            "
          >
            <h3 className="relative z-[2] text-[12px] font-bold uppercase tracking-[0.8px] text-[#667085]">
              {title}
            </h3>
            <p
              className="
                relative z-[2] text-[38px] font-extrabold leading-none tracking-[-1.5px]
                bg-gradient-to-br from-[#312e81] via-[#4f46e5] to-[#7c3aed]
